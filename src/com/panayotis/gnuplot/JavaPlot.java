...
public class JavaPlot extends GNUPlot {
	 ...
	 * @param function
	 */
	public void addPlot(String function, String title) {
		addPlot(new FunctionPlot(function, title));
	}
	 ...
	 * @param variables
	 */
	public void addPlotWithFit(DataSet set, String equation, String[] variables, int depVarCount) {
		addDataSetFit(new DataSetFit(set, equation, variables, depVarCount, true));
	}
	 ...
	 * @param variables
	 */
	public void addFit(DataSet set, String equation, String[] variables, int depVarCount) {
		addDataSetFit(new DataSetFit(set, equation, variables, depVarCount, false));
	}
}
